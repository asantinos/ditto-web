...
Some antivirus products treat unsigned Electron apps as suspicious. The installer is safe — you can verify by checking the SHA-256 hash on the [release page](https://github.com/asantinos/ditto/releases) against the file you downloaded. Whitelist `Ditto-Setup-1.0.0.exe` in your antivirus and try again.
